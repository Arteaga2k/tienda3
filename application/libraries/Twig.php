...
/**
 * Library to wrap Twig layout engine.
 * Originally from Bennet Matschullat.
...
class Twig
{
     ...
     * @param string $name
     *            name of function
     * @param Twig_FunctionInterface $function
     *            Function pointer
     *            
     * @return void
     *
